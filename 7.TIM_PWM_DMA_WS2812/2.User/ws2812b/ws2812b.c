...
void WS2812_Init()
{
	...
	timer_channel_output_mode_config(WS2812B_TIMER, WS2812B_TIMER_CH, TIMER_OC_MODE_PWM1);
	...
	dma_init_struct.periph_addr  = (uint32_t)&(WS2812B_TIMER_CHCV(WS2812B_TIMER));//TIMER0_CH0CV;
	...
	timer_dma_enable(WS2812B_TIMER, TIMER_DMA_CH0D);
...
u8 WS2812_Refresh(void)
{
	...
	dma_transfer_number_config(WS2812B_DMA, WS2812B_DMA_CNANNLE, 24 * PIXEL_MAX + 1);
	dma_channel_enable(WS2812B_DMA, WS2812B_DMA_CNANNLE);
	timer_enable(WS2812B_TIMER);
	return 1;
}
