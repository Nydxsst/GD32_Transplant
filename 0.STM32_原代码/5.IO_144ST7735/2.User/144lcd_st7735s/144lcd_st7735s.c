...
#define SDA_H 		ST7735S_CPT144_SDA_PORT->ODR|=1<<15
#define SDA_L 		ST7735S_CPT144_SDA_PORT->ODR&=~(1<<15)
#define SCL_H 		ST7735S_CPT144_SCL_PORT->ODR|=1<<13
#define SCL_L 		ST7735S_CPT144_SCL_PORT->ODR&=~(1<<13)
...
void ST7735S_CPT144_GPIO_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(ST7735S_CPT144_A0_SCK | ST7735S_CPT144_CS_SCK |
	                       ST7735S_CPT144_RES_SCK | ST7735S_CPT144_SDA_SCK |
	                       ST7735S_CPT144_SCL_SCK | ST7735S_CPT144_BLK_SCK, ENABLE);
	...
	GPIO_InitStructure.GPIO_Pin = ST7735S_CPT144_SDA_PIN;
	GPIO_Init(ST7735S_CPT144_SDA_PORT, &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_Pin = ST7735S_CPT144_SCL_PIN;
	GPIO_Init(ST7735S_CPT144_SCL_PORT, &GPIO_InitStructure);
