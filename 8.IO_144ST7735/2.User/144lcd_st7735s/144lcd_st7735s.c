...
#define SDA_H 		  gpio_bit_set(ST7735S_CPT144_SDA_PORT,ST7735S_CPT144_SDA_PIN)
#define SDA_L 		gpio_bit_reset(ST7735S_CPT144_SDA_PORT,ST7735S_CPT144_SDA_PIN)
#define SCL_H 		  gpio_bit_set(ST7735S_CPT144_SCL_PORT,ST7735S_CPT144_SCL_PIN)
#define SCL_L 		gpio_bit_reset(ST7735S_CPT144_SCL_PORT,ST7735S_CPT144_SCL_PIN)
...
void ST7735S_CPT144_GPIO_Init(void)
{
	...
	rcu_periph_clock_enable(ST7735S_CPT144_SDA_SCK);
	rcu_periph_clock_enable(ST7735S_CPT144_SCL_SCK);
	...
	gpio_init(ST7735S_CPT144_SDA_PORT, GPIO_MODE_OUT_PP, GPIO_OSPEED_50MHZ, ST7735S_CPT144_SDA_PIN);
	gpio_init(ST7735S_CPT144_SCL_PORT, GPIO_MODE_OUT_PP, GPIO_OSPEED_50MHZ, ST7735S_CPT144_SCL_PIN);
